...
# Zadatak pod a)
data = pd.read_csv('LV3 Upoznavanje s Pandas bibliotekom. Predobrada podataka i eksplorativna analiza podataka-20240503\data_C02_emission.csv')
